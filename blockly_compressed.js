...
;(function (root, factory) {
    ...
    Blockly.Events.filter = function (a, b) {
        ...
        for (var c = [], d = Object.create(null), e = 0, f; f = a[e]; e++) if (!f.isNull()) {
            ...
            if (!h) d[g] = {
                ...
                f.newValue; else if (f.type != Blockly.Events.CLICK || k.type != Blockly.Events.BUBBLE_OPEN) d[g] = {
                event: f,
                index: e
            }, c.push(f)
        }
    ...
    Blockly.Css.CONTENT = [".blocklySvg {", "background-color: #fff;", "outline: none;", "overflow: hidden;", "position: absolute;", "display: block;", "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 99999;", "}", ".injectionDiv {", "height: 100%;", "position: relative;", "overflow: hidden;", "touch-action: none;", "}", ".blocklyNonSelectable {", "user-select: none;", "-ms-user-select: none;", "-webkit-user-select: none;", "}", ".blocklyWsDragSurface {", "display: none;", "position: absolute;", "top: 0;",
        ...
        "margin: 0;", "padding: 0;", "}", ".blocklyHtmlInput {", "border: none;", "border-radius: 4px;", "height: 100%;", "margin: 0;", "outline: none;", "padding: 0;", "width: 100%;", "text-align: center;", "display: block;", "box-sizing: border-box;", "}", ".blocklyHtmlInput::-ms-clear {", "display: none;", "}", ".blocklyMainBackground {", "stroke-width: 0;", "stroke: #c6c6c6;", "}", ".blocklyMutatorBackground {", "fill: #fff;", "stroke: #ddd;", "stroke-width: 1;", "}", ".blocklyFlyoutBackground {", "fill: #505781;", "fill-opacity: 1;",
    ...
    Blockly.FlyoutMetricsManager.prototype.getAbsoluteMetrics = function () {
        ...
        return this.flyout_.horizontalLayout ? {top: 0, left: a} : {top: a, left: 0}
    };
    ...
    Blockly.PluginManager.prototype.addPlugin = function (a) {
        ...
        for (var b = 0, c; c = a.types[b]; b++) c = String(c).toLowerCase(), void 0 === this.typeToPluginIds_[c] ? this.typeToPluginIds_[c] = [a.id] : this.typeToPluginIds_[c].push(a.id)
    };
    ...
    Blockly.WorkspaceSvg = function (a, b, c) {
        ...
        this.themeManager_ = this.options.parentWorkspace ? this.options.parentWorkspace.getThemeManager() :
            new Blockly.ThemeManager(this, this.options.theme || Blockly.Themes.Classic);
    ...
    Blockly.WorkspaceSvg.prototype.resize = function () {
        ...
        for (var a = this.pluginManager_.getPlugins(Blockly.PluginManager.Type.POSITIONABLE, !0), b = this.getMetricsManager().getUiMetrics(), c = [], d = 0, e; e = a[d]; d++) e.position(b, c), c.push(e.getBoundingRectangle());
    ...
    Blockly.inject.bindDocumentEvents_ = function () {
        ...
        }), Blockly.browserEvents.conditionalBind(document, "keydown", null, Blockly.onKeyDown), Blockly.browserEvents.bind(document, "touchend", null, Blockly.longStop_), Blockly.browserEvents.bind(document, "touchcancel", null, Blockly.longStop_), Blockly.utils.userAgent.IPAD &&
    ...
    Blockly.Flyout.prototype.init = function (a) {
        ...
        Array.prototype.push.apply(this.eventWrappers_,
            Blockly.browserEvents.conditionalBind(this.svgBackground_, "mousedown", this, this.onMouseDown_));
    ...
    Blockly.Flyout.prototype.dispose = function () {
        ...
        this.svgGroup_ && (Blockly.utils.dom.removeNode(this.svgGroup_), this.svgGroup_ = null);
        this.targetWorkspace = this.svgBackground_ =
            null
    };
    ...
    Blockly.Trashcan = function (a) {
        ...
        0 >= this.workspace_.options.maxTrashcanContents || (a = new Blockly.Options({
            ...
            move: {scrollbars: !0}
        }), this.workspace_.horizontalLayout ? (a.toolboxPosition = this.workspace_.toolboxPosition == Blockly.utils.toolbox.Position.TOP ?
    ...
    Blockly.Trashcan.prototype.position = function (a, b) {
        if (this.verticalSpacing_) {
            ...
            var c = this.BODY_HEIGHT_ + this.LID_HEIGHT_, d = this.top_ = a.absoluteMetrics.top + this.verticalSpacing_,
            ...
            for (var f = this.getBoundingRectangle(), g = 0, h; h = b[g]; g++) f.intersects(h) && (this.top_ = a ? h.top - c - this.MARGIN_BOTTOM_ : h.bottom + this.MARGIN_BOTTOM_, f = this.getBoundingRectangle(), g = -1);
    ...
    Blockly.ZoomControls.prototype.position = function (a, b) {
        if (this.verticalSpacing_) {
            ...
            for (var e = this.getBoundingRectangle(), f = 0, g; g = b[f]; f++) e.intersects(g) && (this.top_ = a ? g.top - this.HEIGHT_ - this.MARGIN_BOTTOM_ : g.bottom +
                this.MARGIN_BOTTOM_, e = this.getBoundingRectangle(), f = -1);
